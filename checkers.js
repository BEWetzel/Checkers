...
var GamePiece = /** @class */ (function () {
    ...
    //            ] 
    function GamePiece(kinged, playerID, playerPieceID, posX, posY, aMoves) {
        if (kinged === void 0) { kinged = false; }
        if (playerID === void 0) { playerID = 0; }
        if (playerPieceID === void 0) { playerPieceID = 0; }
        if (posX === void 0) { posX = 0; }
        if (posY === void 0) { posY = 0; }
        if (aMoves === void 0) { aMoves = []; }
        this.kinged = kinged;
    ...
    GamePiece.prototype.clone = function () {
        var nMoves = [];
        this.aMoves.forEach(function (move) {
            var n = [];
        ...
        var result = new GamePiece(this.kinged.valueOf(), this.playerID.valueOf(), this.playerPieceID.valueOf(), this.posX.valueOf(), this.posY.valueOf(), nMoves);
        return result;
    };
    ...
    GamePiece.prototype.movesToString = function () {
        var result = "";
        var moves = "";
        ...
        if (this.aMoves.length > 0) {
            ...
            this.aMoves.forEach(function (aMove, index) {
    ...
    GamePiece.prototype.jumpsToString = function () {
        var result = "";
        var jumps = "";
        // if the available moves list has moves in it
        if (this.aMoves.length > 0) {
...
var Player = /** @class */ (function () {
    ...
    Player.prototype.clone = function () {
        ...
        var result = new Player(this.playerID.valueOf(), p);
        return result;
    };
    Player.prototype.movesToString = function () {
        var result = " PLAYER " + (this.playerID + 1) + " Moves: \n";
...
var GameSpace = /** @class */ (function () {
    function GameSpace(c, p) {
        this.color = c;
        if (p !== undefined) {
            this.piece = p;
        }
    }
    GameSpace.prototype.clone = function () {
        var _a;
        var p = this.piece;
        if (this.piece !== undefined) {
            p = (_a = this.piece) === null || _a === void 0 ? void 0 : _a.clone();
        }
        var result = new GameSpace(this.color.valueOf(), p);
        return result;
    };
    return GameSpace;
}());
...
var GameState = /** @class */ (function () {
    function GameState(players, board, end, currentPlayerID) {
    ...
    GameState.prototype.clone = function () {
        ...
        var result = new GameState(nPlayers, nBoard, this.end.valueOf(), (_a = this.currentPlayerID) === null || _a === void 0 ? void 0 : _a.valueOf());
        return result;
    };
    GameState.prototype.toString = function () {
        var result = "State Printout: \n";
        result += "   Players: ";
    ...
    GameState.prototype.piecesToString = function () {
        var result = "Board Pieces Printout: ";
                    ...
                    switch (answer.toLowerCase().trim()) {
                        case "play": {
                            ...
                            choosePlayer().then(function (id) {
                                ...
                                // console.log(debug + "current player = " + checkers.currentPlayerID);
                            }).then(function () { return playGame(checkers); }).then(function () { return readMenuResponse(); });
                            break;
                        }
                        case "rules": {
                            printRules();
        ...
        return __generator(this, function (_a) {
            ...
            if (nState.end == false) {
                promptPlayer(nState, preface).then(function (s) {
                    ...
                    return game;
                }).then(function (s) { return playGame(s); }).then(function (s) {
                    nState = s;
                    return nState;
                });
...
function choosePlayer() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    debug = "DEBUG.choosePlayer: ";
                    return [4 /*yield*/, myInterface.question("Which player would like to go first? > ")];
                case 1:
                    answer = _a.sent();
...
function promptPlayer(state, preface) {
    return __awaiter(this, void 0, void 0, function () {
        var nState, debug, uPiece;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    nState = state.clone();
                    debug = "DEBUG.promptPlayer: ";
                    console.log(nState.players[nState.currentPlayerID].movesToString());
                    return [4 /*yield*/, promptPiece(nState, preface)];
                case 1:
                    uPiece = _a.sent();
                ...
                case 3:
                    ...
                    return [4 /*yield*/, promptPlayer(state, preface)];
                case 4:
                    nState = _a.sent();
                    _a.label = 5;
                case 5: return [2 /*return*/, nState];
            }
        });
    });
}
...
function promptPiece(state, preface) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var debug, answer, strings, coordinates, board, x, y, error_1, answer;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    debug = "DEBUG.promptPiece: ";
                    console.log("Format response like this -> pieceX, pieceY");
                    return [4 /*yield*/, myInterface.question(preface + "Which piece would you like to move? > ")];
                case 1:
                    answer = _c.sent();
                    _c.label = 2;
                case 2:
                    ...
                    strings.forEach(function (position) {
                    ...
                    if (isTargetOnBoard(board, x, y)) {
                        ...
                        if (typeof board[y][x].piece !== 'undefined') {
                            ...
                            if (((_a = board[y][x].piece) === null || _a === void 0 ? void 0 : _a.playerID) == state.currentPlayerID &&
                                ((_b = board[y][x].piece) === null || _b === void 0 ? void 0 : _b.aMoves.length) >= 1) {
                                return [2 /*return*/, board[y][x].piece];
                            }
                        }
                    }
                ...
                case 3:
                    error_1 = _c.sent();
                    return [4 /*yield*/, myInterface.question("That was not a valid response. Would you like to TRY again, or go BACK? >")];
                case 4:
                    answer = _c.sent();
                    // clean off the response 
                    switch (answer.toLowerCase().trim()) {
                        ...
                        case "try":
                        default: {
                            return [2 /*return*/, promptPiece(state, preface)];
                        }
                    }
                    return [3 /*break*/, 5];
...
function promptMove(state, preface, piece) {
    return __awaiter(this, void 0, void 0, function () {
        var debug, nState, x, y, nPiece, answer, strings, coordinates, tX, tY, i, j, error_2, answer, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    debug = "DEBUG.promptMove: ";
                    nState = state.clone();
                    x = piece.posX;
                    y = piece.posY;
                ...
                case 2:
                    ...
                    tX = coordinates[0];
                    tY = coordinates[1];
                    if (!(tX !== undefined && tY !== undefined)) return [3 /*break*/, 9];
                    i = 0;
                    _b.label = 3;
                case 3:
                    if (!(i < nPiece.aMoves.length)) return [3 /*break*/, 9];
                    if (!(nPiece.aMoves[i][0] == tX && nPiece.aMoves[i][1] == tY)) return [3 /*break*/, 8];
                    // move the piece
                    nState = movePiece(nState, nState.currentPlayerID, nPiece, nPiece.aMoves[i]);
                    if (!(nPiece.aMoves[i][2] == 1)) return [3 /*break*/, 7];
                    // grab updated moves list
                    nPiece = nState.board[tY][tX].piece;
                    j = 0;
                    _b.label = 4;
                case 4:
                    if (!(j < nPiece.aMoves.length)) return [3 /*break*/, 7];
                    if (!(nPiece.aMoves[j][2] == 1)) return [3 /*break*/, 6];
                    return [4 /*yield*/, promptJump(nState, preface, nPiece)];
                case 5:
                ...
                case 9:
                    ...
                    return [4 /*yield*/, promptMove(state, preface, piece)];
                case 10:
                    nState = _b.sent();
                    return [2 /*return*/, nState];
                case 11:
                ...
                case 12:
                    ...
                    _a = answer;
                    switch (_a) {
                        case "back": return [3 /*break*/, 13];
                        case "try": return [3 /*break*/, 15];
                    }
                    return [3 /*break*/, 15];
                case 13:
                ...
                case 16:
                    nState = _b.sent();
                    return [3 /*break*/, 17];
                case 17: return [2 /*return*/, nState];
                case 18: return [2 /*return*/];
            }
        });
    });
}
function promptJump(state, preface, piece) {
    return __awaiter(this, void 0, void 0, function () {
        var nState, x, y, nPiece, answer, strings, coordinates, tX, tY, i, j, error_3, answer, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    nState = state.clone();
                ...
                case 9:
                    ...
                    return [4 /*yield*/, promptJump(state, preface, piece)];
                case 10:
                    nState = _b.sent();
                    return [2 /*return*/, nState];
                case 11:
                ...
                case 12:
                    ...
                    return [3 /*break*/, 15];
                case 13: return [4 /*yield*/, promptPlayer(state, preface)];
                case 14:
                    nState = _b.sent();
                    return [3 /*break*/, 17];
                case 15: return [4 /*yield*/, promptJump(state, preface, piece)];
                case 16:
                    nState = _b.sent();
                    return [3 /*break*/, 17];
                case 17: return [2 /*return*/, nState];
...
function movePiece(state, tPlayerID, tPiece, tMove) {
    var debug = "DEBUG.movePiece: ";
    ...
    // if (run) {
    var oldX = tPiece.posX;
    var oldY = tPiece.posY;
    var newX = tMove[0];
    var newY = tMove[1];
    ...
    if (tMove[2] < 1) { // no jumps involved
        ...
        nState.players.forEach(function (player) {
...
function updateMoves(boardState, piece, moved, oldX, oldY, jumped, jumpedX, jumpedY) {
    var debug = "DEBUG.updateMoves: ";
    var nState = boardState.clone();
    if (typeof piece !== 'undefined') { // if there is a piece in the space we are looking at, update that piece's moves
        var nPiece = piece.clone();
        var team = piece.playerID;
        var x = nPiece.posX;
        var y = nPiece.posY;
...
function removePieceFromBoardState(state, piece) {
    var nState = state.clone();
    var x = piece.posX;
    var y = piece.posY;
    var pL = [];
    var pLIndex = 0;
    var debug = "DEBUG.removePieceFromBoardState: ";
    ...
    nState.board.forEach(function (col) {
        col.forEach(function (space) {
            if (space.piece !== undefined) {
...
function checkValidMove(board, x, y, p, direction) {
    var debug = "DEBUG.checkValidMove: ";
    // console.log(debug + "Checking Move Pattern for (" + x + ", " + y + "), in the " + direction + " direction.");
    var validMove = undefined;
    switch (direction) {
        case 0: { // northWest
...
//  -- direction: number indicating the direction the piece is trying to move
//      // 0= northWest, 1=northEast, 2=southEast, 3=southWest
function isAdjacentOccupied(board, x, y, direction) {
    var debug = "DEBUG.isAdjacentOccupied: ";
...
function isTargetOnBoard(board, x, y) {
    var isOnBoard = false;
...
//      // 0= northWest, 1=northEast, 2=southEast, 3=southWest
function canJump(board, x, y, p, direction) {
    var debug = "DEBUG.canJump: ";
...
function buildCheckersBoard(tempBoard, redStart) {
    var debug = "DEBUG.buildCheckersBoard: ";
    var color = true; // used for making checker pattern
    ...
    var nState = new GameState([new Player(0, p1), new Player(1, p2)], tempBoard, false);
...
function buildBasicBoard() {
    var board = []; // make an empty 2D Array
    var debug = "DEBUG.buildBasicBoard: ";
    for (var y = 0; y < 8; y++) {
        var col = []; // define empty 1D Array for new Board Column
        // Fill board column with colored spaces
        for (var x = 0; x < 8; x++) {
            var space = new GameSpace(paintSquare(x, y));
            col.push(space);
            debug += "(" + x + ", " + y + "), ";
        }
...
function printBoardToConsole(pBoard) {
    console.log("---------------------------");
...
function printTestBoard() {
    var checkers = buildCheckersBoard(buildBasicBoard(), true);
    printBoardToConsole(checkers.board);
